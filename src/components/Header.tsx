    ...
    <div className="flex justify-center border-b py-24">
      <div className="container flex">
        <div className=" mr-16 w-1/3">
          <img src="https://www2.coinbase.com/assets/featureCover.png" />
        </div>
        <div className="w-2/3">
          <h1 className="text-4xl leading-normal px-6">
            ...
            <div className="rounded-full flex items-center justify-center h-16 w-16 info-badge-shadow mr-6">
              ...
              >
                ...
                <g fill="none" fillRule="evenodd">
                  <path
                    d="M27 11a11 11 0 1 1-22 0 11 11 0 0 1 22 0"
                    fill="#D4EEFF"
                  />
                  <path fill="#55B4FC" d="M0 32h32V11H0z" />
                  <path
                    d="M16 22a11 11 0 0 0 11-11H5a11 11 0 0 0 11 11"
                    fill="#1752F0"
                  />
                  <path
                    d="M30 22a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"
                    fill="#FFF"
                  />
                </g>
              </svg>
          ...
          <div className="flex p-6 items-center">
            <div className="rounded-full flex items-center justify-center h-16 w-16 info-badge-shadow mr-6">
              ...
              >
                <g fill="none" fillRule="evenodd">
                  <path
                    d="M14.86 0A9.14 9.14 0 0 0 5.7 9.14v14.63H24V9.14C24 4.1 19.9 0 14.86 0"
                    fill="#D4EEFF"
                  />
            ...
            <div className="rounded-full flex items-center justify-center h-16 w-16 info-badge-shadow mr-6">
              ...
              >
                <g fill="none" fillRule="evenodd">
                  ...
                  />
                  <path
                    d="M17.81 9.5a2.38 2.38 0 0 0 2.38-2.38V4.75h-4.75v2.38A2.38 2.38 0 0 0 17.8 9.5"
                    fill="#1752F0"
                  />
                  <path fill="#FFF" d="M4.75 34.44h26.13V11.88H4.75z" />
                  <path
                    fill="#1752F0"
                    d="M12.69 26.33l3.36 3.36L26.12 19.6l-3.35-3.36z"
                  />
                  <path
                    fill="#1752F0"
                    d="M16.05 29.69l3.36-3.36-6.25-6.24-3.35 3.35z"
                  />
                </g>
              </svg>
            </div>
...
const HelpChat = () => {
  return (
    <button
      style={{
        backgroundImage:
          'url(https://d124s1zbdqkqqe.cloudfront.net/Dialogue.svg)',
        backgroundSize: 28,
